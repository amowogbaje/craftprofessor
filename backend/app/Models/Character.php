...
class Character extends Model
{
    ...
    /**
     * Characters that have a portrait prompt queued but no generated image
     * yet, excluding ones that have hard-failed too many times already.
     * Without the attempts cap, a permanently-broken row (bad prompt,
     * provider rejecting it, etc.) stays "oldest" forever and every run
     * would keep re-selecting it before anything queued behind it.
     */
